...
KRvideo = pd.read_csv("/Users/hwangjihye/jihye/Data_Study/ITStudy/youtube/KRvideos.csv")
USvideo = pd.read_csv("/Users/hwangjihye/jihye/Data_Study/ITStudy/youtube/USvideos.csv")
JPvideo = pd.read_csv("/Users/hwangjihye/jihye/Data_Study/ITStudy/youtube/JPvideos.csv")
CAvideo = pd.read_csv("/Users/hwangjihye/jihye/Data_Study/ITStudy/youtube/CAvideos.csv")
MXvideo = pd.read_csv("/Users/hwangjihye/jihye/Data_Study/ITStudy/youtube/MXvideos.csv")
country_list = ['한국', '미국', '일본', '캐나다', '멕시코']
img_list = ['https://i.imgur.com/6BA9OPP.png', 'https://i.imgur.com/Wct8IbO.png', 'https://i.imgur.com/EoTAFG4.png',
            'https://i.imgur.com/Mg24HM7.png', 'https://i.imgur.com/i5Xc7S4.png']
